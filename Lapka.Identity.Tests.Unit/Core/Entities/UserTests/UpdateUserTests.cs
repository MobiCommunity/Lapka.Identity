...
namespace Lapka.Identity.Tests.Unit.Core.Entities.UserTests
{
    public class UpdateUserTests
    {
        ...
        public void given_valid_user_should_be_updated(string username, string firstName, string lastName,
            string phoneNumber)
        {
            User user = Extensions.ArrangeUser();

            user.Update(username, firstName, lastName, new PhoneNumber(phoneNumber));

            user.ShouldNotBeNull();
            user.Username.ShouldBe(username);
            user.FirstName.ShouldBe(firstName);
            user.LastName.ShouldBe(lastName);
            user.PhoneNumber.Value.ShouldBe(phoneNumber);
        ...
        public void given_invalid_user_username_should_throw_an_exception()
        {
            User user = Extensions.ArrangeUser();
            Exception exception =
                Record.Exception(() => user.Update("", user.FirstName, user.LastName, user.PhoneNumber));
        ...
        public void given_too_short_user_firstname_should_throw_an_exception()
        {
            ...
            Exception exception =
                Record.Exception(() => user.Update(user.Username, "I", user.LastName, user.PhoneNumber));
        ...
        public void given_too_long_user_firstname_should_throw_an_exception()
        {
            ...
            Exception exception = Record.Exception(() =>
                user.Update(user.Username, tooLongFirstName, user.LastName, user.PhoneNumber));
        ...
        public void given_too_short_user_lastname_should_throw_an_exception()
        {
            ...
            Exception exception =
                Record.Exception(() => user.Update(user.Username, user.FirstName, "I", user.PhoneNumber));
        ...
        public void given_too_long_user_lastname_should_throw_an_exception()
        {
            ...
            Exception exception = Record.Exception(() =>
                user.Update(user.Username, user.FirstName, tooLongLastName, user.PhoneNumber));
        ...
        public void given_invalid_user_phone_number_should_throw_an_exception(string phoneNumber)
        {
            ...
            Exception exception = Record.Exception(() =>
                user.Update(user.Username, user.FirstName, user.LastName, new PhoneNumber(phoneNumber)));
